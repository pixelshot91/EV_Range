...
time::minute_t Vehicle::get_time_to_recharge(const length::kilometer_t range_to_gain, const ChargingCurve max_charger_cc)
{
  ChargingCurve actual_cc = max_power_cc.min(max_charger_cc);
